...
public class DispenserGraph {
    ...
    private Map<DispenserHeatData, List<DispenserHeatData>> adjList = new ConcurrentHashMap<>();
    ...
    public Map<DispenserHeatData, List<DispenserHeatData>> getAdjList() {
        return adjList;
    }

    public void addDispenser(DispenserHeatData dispenserHeatData) {
        // Use putIfAbsent, otherwise you will reset the entire thing everytime!
        adjList.putIfAbsent(dispenserHeatData, new ArrayList<>());
    }
    ...
    public void makeEdges() {
        ...
        for (DispenserHeatData dispenser1 : adjList.keySet()) {
            ...
            for (byte[] dir : overheatProperties.directions()) {
                ...
                for (DispenserHeatData dispenser2 : adjList.keySet()) {
    ...
    public void removeDispenser(DispenserHeatData dispenserHeatData) {
        this.adjList.values().remove(dispenserHeatData);
        this.adjList.remove(dispenserHeatData);
    }
}
